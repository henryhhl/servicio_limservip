...
class CreateMySolicitud extends Component {
    ...
    get_data() {
        axios.get( web.servidor + '/mysolicitud_pedido/create').then(
            (response) => {
    ...
    onSubmit() {
        ...
        axios(
            {
                method: 'post',
                url: web.servidor + '/mysolicitud_pedido/store',
                data: formdata,
                headers: {
...
CreateMySolicitud.propTypes = {
    buttoncolor: PropTypes.string,
}

CreateMySolicitud.defaultProps = {
    buttoncolor: '',
}

export default withRouter(CreateMySolicitud);
