...
class IndexMySolicitudAsignado extends Component {
    ...
    componentDidMount() {
        this.props.get_link('mysolicitud_asignado', true); //#3f6ad8 co //#e0f3ff bg bold
        this.get_data();
    }
    get_data(page = 1, search = '') {
        axios.get( web.servidor + '/mysolicitud_asignado/index?page=' + page + '&search=' + search).then(
            (response) => {
            ...
            <div className="rows">
                <div className="cards">
                    <div className="card-header-tab card-header mt-4" style={{border: '1px solid transparent'}}>
                        ...
                        <div className="btn-actions-pane-right mb-4 ml-4">
...
IndexMySolicitudAsignado.propTypes = {
...
IndexMySolicitudAsignado.defaultProps = {
    solicitud: [],
    pagination: {
        solicitud: {
            'total': 0,
...
export default withRouter(IndexMySolicitudAsignado);
