...
class ShowMySolicitudAsignado extends Component {
    ...
    componentDidMount() {
        this.props.get_link('mysolicitud_asignado', true);
        this.get_data();
    }
    get_data() {
        axios.get( web.servidor + '/mysolicitud_asignado/show/' + this.props.match.params.id ).then(
            (response) => {
    ...
    onBack() {
        this.props.history.push( web.serv_link + '/mysolicitud_asignado');
    }

    onUpdateEstado() {
        if (this.state.proceso == 'E') {
            notification.warning({
                description: 'FAVOR DE SELECCIONAR EL ESTADO YA QUE EL ACTUAL ESTA EN PROCESO.',
            });
        }else {
            this.onSesion();
        }
    ...
    onSubmit() {
        ...
        formdata.append('proceso', this.state.proceso);
        formdata.append('id', this.props.match.params.id);
        axios(
            {
                method: 'post',
                url: web.servidor + '/solicitud/update_estado',
                data: formdata,
                headers: {
            ...
            <div className="rows">
                ...
                <div className="cards">
                    <div className='forms-groups'>
                        <Card
                            style={{ width: '100%', minWidth: '100%', }}
                            title="DETALLE SOLICITUD PEDIDO ASIGNADO"
                        ...
                        >
                            <div className="forms-groups">
                                    ...
                                    <div className='cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12' style={{paddingTop: 4, }}>
                                        ...
                                        <div className='cols-lg-3 cols-md-3 cols-sm-3 cols-xs-12' style={{paddingTop: 0, }}>
                                            <div className='inputs-groups'>
                                                <Select style={{ width: '100%', minWidth: '100%', }} 
                                                    onChange={(value) => this.setState({proceso: value,})}
                                        ...
                                        <div className='cols-lg-3 cols-md-3 cols-sm-3 cols-xs-12' style={{paddingTop: 0, }}>
                                            <button className="btn-transition btn btn-outline-primary"
                                                onClick={this.onUpdateEstado.bind(this)}
                                            >
                                                ACTUALIZAR
                                            </button>
                                        </div>
                                ...
                                <div className='cols-lg-2 cols-md-2 cols-sm-2 cols-xs-12' style={{paddingTop: 4, }}>
                                    <div className='inputs-groups'>
                                ...
                                <div className='cols-lg-2 cols-md-2 cols-sm-2 text-center' style={{paddingTop: 4, }}>
...
ShowMySolicitudAsignado.propTypes = {
    buttoncolor: PropTypes.string,
}

ShowMySolicitudAsignado.defaultProps = {
    buttoncolor: '',
}

export default withRouter(ShowMySolicitudAsignado);
