...
class IndexCategoria extends Component {
    ...
    componentDidMount() {
        this.props.get_link('categoria', true); //#3f6ad8 co //#e0f3ff bg bold
        this.get_data();
    }
    ...
    onShow(data, event) {
        ...
        this.props.history.push( web.serv_link + '/categoria/show/' + data.id);
    }
    onEdit(data, event) {
        event.preventDefault();
...
export default withRouter(IndexCategoria);
