<div class="py-1 bg-black top" style="background-color: #76448A">
    <div class="container">
            ...
            <div class="col-lg-12 d-block">
                <div class="row d-flex">
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        ...
                        <span class="text">+ 591 6348651</span>
                    </div>
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        <div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
                        <span class="text">limservip365@gmail.com</span>
                    </div>
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="index.html">Limservip</a>
...
<section class="hero-wrap js-fullheight" style="background-image: url('plantilla/images/limpieza.jpg');" data-section="home" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
          		<span class="subheading" style="color: #76448A"><b>Bienvenido a Limservip</b></span>
	            <h1 class="mb-4">Nosotros estamos <br>para facilitarte tus tareas</h1>
	            <p class="mb-4">Te ayudamos con la limpieza de tu negocio y hogar</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
        <div class="row d-flex">
            <div class="col-md-6 col-lg-5 d-flex">
                <div class="img d-flex align-self-stretch align-items-center" style="background-image:url(plantilla/images/perfilnegocio.jpg);">
                </div>
            </div>
